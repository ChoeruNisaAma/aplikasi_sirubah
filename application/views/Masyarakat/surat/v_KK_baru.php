      ...
      <div class="card shadow py-2 px-5">
        <div class="card mb-3" style="width: 720px;">
         ...
         <form  role="form" class="kirim_surat">
          <h6 class="mb-3 font-weight-bold">Untuk mengajukan permohonan surat KK Baru, silahkan lengkapi berkas berikut!</h6>
            ...
            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Scan SK Kehilangan</label>
                <div class="col-5 px-1">
                  ...
                  <label class="label" style="width: 510px">*Hanya diisi ketika mengajukan permohonan KK karena kehilangan</label> 
                </div>
            </div> 
          ...
          <input type="text" id="controller" hidden value="kk_baru">
          <div>  
