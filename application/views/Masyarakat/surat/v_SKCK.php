      ...
      <div class="card shadow py-2 px-5">
        <div class="card mb-3" style="width: 720px;">
         ...
         <form  role="form" class="kirim_surat">
          <h6 class="mb-3 font-weight-bold">Untuk mengajukan permohonan surat SKCK Baru, silahkan lengkapi berkas berikut!</h6>
          ...
          <input type="text" id="controller" hidden value="skck">
          <div>  
