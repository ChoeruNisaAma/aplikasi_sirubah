    ...
    <div class="card-header py-3">
      ...
      <div class="card shadow py-2 px-5">
        ...
        <form  role="form" class="kirim_surat">
          <h6 class="mb-3 font-weight-bold">Untuk mengajukan permohonan surat BDT, silahkan lengkapi berkas berikut!</h6>
             ...
             <div class="form-group row">
              <label class="col-sm-2 col-form-label">Scan KTP</label>
                <div class="col-5">
                  ...
                  <label style="width: 510px" class="custom-file-label" for="customFile" id="label_image2">Unggah Berkas</label>
                </div>
            </div>  

            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Scan KTP Istri</label>
                <div class="col-5">
                  ...
                  <label class="label">*KTP Istri hanya diisi ketika Sudah Menikah </label> 
                </div>
            </div>

            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Scan Surat Pindah Daerah</label>
                <div class="col-5">
                  ...
                  <label class="label">*Hanya diisi jika masih dalam satu kota </label> 
                </div>
            </div>
            ...
            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Scan Surat Nikah</label>
                <div class="col-5">
                  ...
                  <label class="label">*Hanya diisi ketika Sudah Menikah </label> 
                </div>
            </div>

            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Scan Akta Lahir</label>
                <div class="col-5">
                  ...
                  <label class="label">*Hanya diisi bila dari luar kota Semarang</label> 
                </div>
            </div>
          ...
          <input type="text" id="controller" hidden value="bdt">
          <div>  
