    ...
    <div class="card-header py-3">
      ...
      <div class="card shadow py-2 px-5">
        ...
        <form  role="form" class="kirim_surat">
          <h6 class="mb-3 font-weight-bold">Untuk mengajukan permohonan surat pengantar Waris, silahkan lengkapi berkas berikut!</h6>
          <div class="pesan_error"></div>

            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Scan Surat Pernyataan</label>
                <div class="col-5">
                  <input type="file" class="custom-file-input" id="image1" name="image1">
                  <label style="width: 510px" class="custom-file-label" for="customFile" id="label_image1">Unggah Berkas</label>
                  <label class="label">*Surat Pernyataan dari Kelurahan dapat diunduh <a href="<?= filter_var(base_url().'Pengajuan_surat/download_sp_waris') ?>">disini</a></label> 
                </div>
            </div>

            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Scan Akta Kematian</label>
                <div class="col-5">
            ...
            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Berkas Pendukung</label>
                <div class="col-5">
                  ...
                  <label class="label">*Berupa berkas scan KK dan KTP semua ahli waris</label>
                </div>
            </div>
          ...
          <input type="text" id="controller" hidden value="sk_waris">
          <div>  
